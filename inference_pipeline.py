...
def load_model(
    path, device="cuda", model_type="DBPNLL", upscale_factor=8, residual_learning=False
):
...
def create_data_loader(dataset_path, upscale_factor, test_batch_size, threads=1):
    ...
    testing_data_loader = DataLoader(
        dataset=test_set, num_workers=threads, batch_size=test_batch_size, shuffle=False
    )

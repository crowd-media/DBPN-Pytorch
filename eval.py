...
parser.add_argument(
    "--output", default="Results/", help="Location to save checkpoint models"
)
...
parser.add_argument(
    "--model", default="models/DBPNLL_x8.pth", help="sr pretrained base model"
)
...
test_set = get_eval_set(
    os.path.join(opt.input_dir, opt.test_dataset), opt.upscale_factor
)

...
class Net(nn.Module):
    def __init__(self, num_channels, T,base_filter, feat, num_stages, scale_factor):
        ...
        self.feat0 = ConvBlock(num_channels*T, feat, 3, 1, 1, activation='prelu', norm=None)
        ...
        #Reconstruction
        self.output_conv = ConvBlock(num_stages*base_filter, num_channels*T, 3, 1, 1, activation=None, norm=None)

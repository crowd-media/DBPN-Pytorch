...
parser.add_argument(
    "--upscale_factor", type=int, default=8, help="super resolution upscale factor"
)
...
parser.add_argument(
    "--patch_size", type=int, default=40, help="Size of cropped HR image"
)
parser.add_argument(
    "--pretrained_sr",
    default="MIX2K_LR_aug_x4dl10DBPNITERtpami_epoch_399.pth",
...
parser.add_argument(
    "--prefix",
    default="tpami_residual_filter8",
